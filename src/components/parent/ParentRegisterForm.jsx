        ...
        <div className="w-full max-w-md xl:max-w-xl my-auto">
          ...
          >
            <header className="mb-8 flex items-baseline justify-between">
              <div>
                <Link href="/parent" className="inline-flex items-center text-slate-400 hover:text-primary-600 font-black text-[9px] uppercase tracking-widest mb-6 transition-all group">
                ...
                <p className="text-slate-400 font-bold text-sm">Patient & Guardian Provisioning</p>
              </div>
              <div className="text-right">
                <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-1">Phase</p>
                ...
                {step === 1 ? (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Guardian Full Name</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-2">
                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Patient Registry ID</label>
                        <div className="relative group">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="space-y-2">
                        ...
                        <select name="gender" value={formData.gender} onChange={handleInputChange} className="w-full px-4 py-4 bg-white border border-slate-100 rounded-2xl text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-600/5 focus:border-primary-600 transition-all font-bold text-sm shadow-sm appearance-none">
                          <option>Male</option>
                      ...
                      <div className="space-y-2">
                        ...
                        <input name="semester" type="number" min="1" max="12" value={formData.semester} onChange={handleInputChange} className="w-full px-4 py-4 bg-white border border-slate-100 rounded-2xl text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-600/5 focus:border-primary-600 transition-all font-bold text-sm shadow-sm" required />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Care Type</label>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <input name="address" placeholder="123 Care Street, Medical District" value={formData.address} onChange={handleInputChange} className="w-full px-6 py-4 bg-white border border-slate-100 rounded-2xl text-slate-800 placeholder-slate-200 focus:outline-none focus:ring-4 focus:ring-primary-600/5 focus:border-primary-600 transition-all font-bold text-sm shadow-sm" required />
                    </div>
